...
const Page = () => {
  ...
  const {data} = useQuery<{ synced: boolean }>({
    queryFn: async () => {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center px-4">
        <div className="relative flex w-full flex-col items-center justify-center gap-6 text-center">
          <BackgroundPattern className="absolute inset-0 left-1/2 -translate-x-1/2 opacity-75" />
          <div className="relative z-10">
            <LoadingSpinner size="lg" />
            <Heading>Creating your account...</Heading>
            <p className="text-base mt-5 text-gray-600 max-w-prose">
