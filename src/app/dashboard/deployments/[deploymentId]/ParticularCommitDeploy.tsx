...
const ParticularCommitDeploy: React.FC<CommitChoiceProps> = ({ token,isPrivate, repoName, repoOwner, onCommitSubmit, onClose }) => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      const data = await fetchCommits(repoOwner, repoName, { isPrivate: isPrivate, token });
